...
import { loginUser } from "../../../graphql/mutations/users";
...
function Login({ history }) {
  ...
  const submitLogin = async (e) => {
    ...
    setSubmitting(true);
    try {
      const res = await login({ variables: { email, password, role: "admin" } });
      console.log(res);
      setInStorage("token", res.data.loginUser.token);
      setInStorage("user_id", res.data.loginUser.user_id);
